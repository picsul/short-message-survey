...
message = "Thank you so much for participating in our study this semester! If you haven't already, please complete the end of the semester survey: https://bit.ly/cosc-102-ps. Your response is very valuable to us and greatly appreciated."

@sched.scheduled_job('cron', day_of_week='thu', hour='15', minute='00', timezone='US/Eastern')
def post_reminder():
    message_the_list(nums, message, twilio_numbers[1])
