...
@sched.scheduled_job('cron', day_of_week='thu', hour='13', minute='52', timezone='America/New_York')
def test_message():
...
@sched.scheduled_job('cron', day_of_week='thu', hour='13', minute='50', timezone='America/New_York')
def test_message_2():
