...
@sched.scheduled_job('cron', day_of_week='thu', hour='12', minute='42', timezone='America/New_York')
def message():
    message_the_list(new_list, '+19179949576', 'Ready to take survey 1?')
    

@sched.scheduled_job('cron', day_of_week='thu', hour='12', minute='45', timezone='America/New_York')
def message():
