...
@sched.scheduled_job('cron', day_of_week='fri', hour='12', minute='45', timezone='America/New_York')
def josh_message():
...
@sched.scheduled_job('cron', day_of_week='fri', hour='10', minute='23', timezone='America/New_York')
def josh_message():
